...
# confusion matrix
# calibration curve
plotCalibrationCurve(df_enr['reachedStrikePrice'], df_enr['prob'], title='', bins=10, savefig=True, saveFileName='validation/content/CalibCurve.png')

print('Created and saved calibration plot')

# model performance
# AUC and similar
auc_roc = plotCurveAUC(df_enr['prob'],df_enr['reachedStrikePrice'], title='', type='roc', savefig=True, saveFileName='validation/content/roc.png')
...
sendRichEmail(sender='k.sends.python@gmail.com'
			  ...
			  , inline_images = ['validation/content/scatter.png','validation/content/CalibCurve.png','validation/content/roc.png']
			  , attachment = None)
